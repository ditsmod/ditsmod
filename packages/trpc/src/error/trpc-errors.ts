 ...
 * of the route decorator to be an TrpcHttpInterceptor or an extension group token, but got: ${whatIsThis}.
 *
 */
  ...
  constructor(whatIsThis: string) {
    super({
      msg1:
        ...
        'expected the second parameter of the route decorator to be an TrpcHttpInterceptor ' +
