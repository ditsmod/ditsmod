export type MediaType = 'application' | 'audio' | 'example' | 'font' | 'image' | 'message' | 'model' | 'multipart' | 'text' | 'video';
...
export type AudioMediaSubtype =
  'basic' | 'L24' | 'mp4' | 'aac' | 'mpeg' | 'ogg' | 'vorbis' | 'x-ms-wma' | 'x-ms-wax' | 'vnd.rn-realaudio' | 'vnd.wave' | 'webm';
export type ImageMediaSubtype = 'gif' | 'jpeg' | 'pjpeg' | 'png' | 'svg+xml' | 'tiff' | 'vnd.microsoft.icon' | 'vnd.wap.wbmp' | 'webp';
