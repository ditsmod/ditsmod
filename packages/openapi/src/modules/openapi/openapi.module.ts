...
@Module({
  ...
  providersPerApp: [
    ...
    { provide: OAS_PATCH_METADATA_EXTENSIONS, useClass: OpenapiPatchMetadataExtension, multi: true },
  ...
  extensions: [edk.ROUTES_EXTENSIONS, OAS_COMPILER_EXTENSIONS, OAS_PATCH_METADATA_EXTENSIONS],
})
