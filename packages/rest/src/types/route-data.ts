import type { Class, Context, ResolvedGuard, ResolvedGuardPerMod, ResolvedProvider } from '@ditsmod/core';

/**
 * This metadata is generated by `RestRouteExtension` group, and available via DI.
 */
