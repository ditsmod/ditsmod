export type CronOptions = {
  /**
   * Specify the name of your cron job. This will allow you to get reference to it via SchedulerRegistry.
   */
  name?: string;
  ...
  /**
   * If you have code that keeps the event loop running and want to stop the node process when that finishes, you can do so.
   */
