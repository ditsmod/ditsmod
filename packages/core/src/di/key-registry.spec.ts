...
describe('getParamToken()', () => {
  it('creation param token', () => {
    ...
    expect(PARAM_TOKEN1.toString()).toBe('SOME_TOKEN1-with-ctx-data-1-1');
    expect(PARAM_TOKEN2.toString()).toBe('SOME_TOKEN2-with-ctx-data-2-1');
    expect(PARAM_TOKEN3.toString()).toBe('SOME_TOKEN2-with-ctx-data-2-2');
    expect(PARAM_TOKEN1_1.toString()).toBe('SOME_TOKEN1-with-ctx-data-1-2');
    expect(PARAM_TOKEN1_2.toString()).toBe('SOME_TOKEN1-with-ctx-data-1-3');
