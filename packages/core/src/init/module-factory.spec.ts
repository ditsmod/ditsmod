  ...
  describe('bootstrap()', () => {
    ...
    describe('exporting providers order', () => {
      ...
      it('case 1', () => {
        ...
        expect(mod1?.baseMeta.providersPerMod).toEqual([providerPerMod1, Provider1, Provider2, Provider3]);
        ...
        expect(mod2?.baseMeta.providersPerMod).toEqual([
          providerPerMod2,
          Provider4,
          Provider5,
          Provider6,
        ...
        expect(mod2?.baseMeta.providersPerMod.slice(1)).toEqual([
          Provider4,
          Provider5,
          Provider6,
          Provider7,
      ...
      it('case 2', () => {
        ...
        mock.bootstrap(new GlobalProviders(), Module4, moduleManager, new Set());
