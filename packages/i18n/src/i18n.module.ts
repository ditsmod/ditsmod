...
import { I18nOptions, I18nTranslation, I18N_EXTENSIONS, I18N_TRANSLATIONS } from './types/mix';

@Module({
  extensions: [[I18N_EXTENSIONS, PRE_ROUTER_EXTENSIONS, I18nExtension, true]],
  providersPerMod: [
    { provide: I18N_TRANSLATIONS, useValue: [], multi: true },
    I18nService,
    I18nOptions,
    I18nLogMediator
  ],
...
export class I18nModule {
  static withParams(translations: I18nTranslation[]): ModuleWithParams<I18nModule> {
    return {
      module: this,
