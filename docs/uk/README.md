...
В декораторі модуля можна прописувати:
- які саме зовнішні модулі будуть використовуватись в межах поточного модуля;
- перелік контролерів;
- перелік сервісів та рівні, на яких ці сервіси оголошені;
- які саме класи із поточного модуля будуть доступними для використання у зовнішніх модулях.
