...
Наприклад, модуль системи безпеки має чітко визначену мету - безпека доступу та безпека управління
...
Також "чітко визначеною метою" може вважатись забезпечення функціонування розділу, прив'язаного до
певного URL. Наприклад, один модуль може обробляти усі HTTP-запити за адресою `/api/users`, інший
