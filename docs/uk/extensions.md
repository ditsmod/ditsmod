...
конкретного роута чи запиту. Тут варто відзначити, що можливість додавання провайдерів на рівні
роута є унікальною, оскільки у статичному варіанті (через декоратори), на даний момент, такої
можливості немає.

Вбудоване Ditsmod-розширення перед стартом вебсервера аналізує кожен маршрут і якщо
