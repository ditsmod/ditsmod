...
export class PreRequest {
  ...
  requestListener: RequestListener = (nodeReq, nodeRes) => {
     ...
     */
    const { injector, providers, controller, methodName, parseBody, guards } = handleRoute();
    ...
    this.handleRoute(req, controller, methodName, params, queryString, parseBody, guards);
  };
