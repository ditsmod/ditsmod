import { RootModule, LogMediator, LogMediatorConfig, LogFilter, LoggerConfig } from '@ditsmod/core';
...
@RootModule({
  ...
  providersPerApp: [
    ...
    // { provide: LogMediatorConfig, useValue: { logFilter } }, // Uncomment this to see only logs from OtherModule
  ],
})
