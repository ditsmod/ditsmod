...
## Мотивація для створення `@ts-stack/mod`
...
Так чому ж, знаючи про NestJS, виникла потреба у створенні `@ts-stack/mod`? Головною причиною була моя суб'єктивна оцінка NestJS, мені здалось що можна написати веб-фреймворк із простішим API але, разом із тим, зробити його більш потужнішим як в плані продуктивності, так і в плані масштабованості.
