...
- Моживість замінювати by default провайдери, власними провайдерами користувача. Наприклад, швидше за все, ви захочете замінити провайдер логера на ваш власний провайдер, оскільки by default провайдер для логування нічого не записує ні в консоль, ні у файл.
- Можливість будувати хорошу модульність структури всього застосунку, а отже і хорошу масштабованість. Окрім цього, даний DI підтримує ієрархію, а це означає, що ви можете оголошувати сервіси з областю видимості: або на рівні усього застосунку, або на рівні конкретного модуля, або на рівні запиту.
   ...
   3. Сервіс на рівні запиту буде створюватись при кожному створенні інстансу контролера. Наприклад, таким сервісом може бути парсер тіла запиту.
