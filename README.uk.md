...
`@ts-stack/ditsmod` написаний на TypeScript, він є Node.js веб-фреймворком, в назві якого слово `ditsmod` означає хорошу модульність.
...
Мінімальний базовий набір для роботи застосунку `@ts-stack/ditsmod` має репозиторій [ditsmod-seed][2].
...
## Мотивація для створення `@ts-stack/ditsmod`
...
Так чому ж, знаючи про NestJS, виникла потреба у створенні `@ts-stack/ditsmod`? Головною причиною була моя суб'єктивна оцінка NestJS, мені здалось що можна написати веб-фреймворк із простішим API але, разом із тим, зробити його більш потужнішим як в плані продуктивності, так і в плані масштабованості.

### Огляд `@ts-stack/ditsmod`

По великому рахунку, головною особливістю `@ts-stack/ditsmod` є інтеграція рідного Node.js веб-сервера з модулем [Dependency Injection][1] (скорочено - DI).
...
- Не зважаючи на додатковий прошарок у ядрі `@ts-stack/ditsmod` для підтримки модульності застосунку, тести "Hello, World!" показують, що він працює навіть трохи швидше за KoaJS:
