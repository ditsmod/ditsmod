...
По великому рахунку, головною особливістю Ditsmod є інтеграція рідного Node.js веб-сервера з модулем [Dependency Injection][1] (скорочено - DI).
...
- Не зважаючи на додатковий прошарок у ядрі Ditsmod для підтримки модульності застосунку, тести "Hello, World!" показують, що він працює навіть трохи швидше за KoaJS:
