...
Таку команду не можна використовувати для продуктового режиму, але вона підійде для розробки застосунку, оскільки після кожного збереження вашого коду, ви зразу бачите ці зміни.
