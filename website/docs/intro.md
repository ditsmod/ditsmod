...
Завдяки використанню у [ditsmod/rest-starter][2] так званих [Project References][16] і режиму збірки `tsgo -b`, навіть дуже великі проекти компілюються дуже швидко.
