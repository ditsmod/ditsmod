...
Після цього виконуваний файл `ditsmod` та його короткий аліас `dm` будуть доступні у системі:
...
Або створити новий застосунок без попереднього встановлення через `npx`:
...
Також ви можете клонувати стартовий репозиторій [ditsmod/rest-starter][2] вручну:
...
У якості альтернативи, ви можете створити стартовий монорепозиторій:
...
Або безпосередньо через Ditsmod CLI (або коротку команду `dm`):
