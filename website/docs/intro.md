...
Ditsmod є добре-розширюваним та швидким веб-фреймворком на базі Node.js, його назва складається з **DI** + **TS** + **Mod**, щоб підкреслити важливі складові: він має **D**ependency **I**njection, написаний на **T**ype**S**cript у форматі ESM, та спроектований для хорошої **Мод**ульності.
...
Будь-ласка, переконайтесь що на вашій операційній системі встановлено Node.js >= v22.11.0.
