...
підміняти через DI. Тобто окрім логера, ви можете підміняти: роутер, обробник
...
оголошених в масиві `providersPerReq`. І хоча він також бачить провайдери батьківських
інжекторів, але він може лише використовувати готові батьківські інстанси провайдерів, а не
