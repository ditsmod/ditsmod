...
У Holu, декоратори та рефлектор є фундаментальними компонентами, які використовуються постійно, і які дозволяють декларативно описувати застосунок. Саме тому вивчення Dismod треба починати з цієї теми.

Давайте спробуємо проекспериментувати зі збереженням статичних типів класу. Створіть файл `src/app/services.ts` в репозиторію [holu/rest-starter][101], та вставте у нього наступний код:
