...
[16]: https://github.com/holujs/holu/blob/v0.1.2/packages/body-parser/src/body-parser.interceptor.ts#L16
[17]: https://github.com/holujs/holu/blob/v0.1.2/examples/14-auth-jwt/src/app/modules/services/auth/bearer.guard.ts#L25
