...
[Ditsmod надає API][4], що дозволяє додати підтримку необхідної архітектури. Такі пакети - більше, ніж звичайні модулі фіч, оскільки вони мають ще й **класи застосунків**, в яких прописано свій конфіг застосунку, своя послідовність збірки застосунку і т.д. Як правило, кожен із цих пакетів має свої особливості модулів фіч. Окрім цього, якщо вебсервер застосунку має свої особливості роботи для різних **Runtimes** (Node, Bun, Deno і т.п.), Ditsmod дозволяє це враховувати саме на етапі ініціалізації класу застосунку.
