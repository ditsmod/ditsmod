...
Інтерсептор-одинак працює дуже подібним чином до неодинака, але при цьому він не використовує інжектор на рівні запиту. Робочий потік за його участі відрізняється у пункті 4 та 7:
