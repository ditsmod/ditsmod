...
Роутер має мапінг між URL та HTTP-обробником запиту. Хоча вам не прийдеться в вручну писати цей мапінг, але для загального уявлення роботи роутера, у дуже спрощеному вигляді цей мапінг можна уявити так:
...
Хоча в попередньому прикладі інстанс класу `Res` запитувався у DI через `method1()`, але аналогічним чином ми можемо запитати цей інстанс і в конструкторі:
