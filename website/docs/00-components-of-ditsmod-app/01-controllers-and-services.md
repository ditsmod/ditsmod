...
1. Контролер неодинак (по дефолту). Його інстанс створюється за кожним запитом.
2. Контролер [одинак][8]. Його інстанс створюється єдиний раз на рівні роуту під час ініціалізації застосунку.
