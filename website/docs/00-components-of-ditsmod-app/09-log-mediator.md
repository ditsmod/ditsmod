...
Потім запустіть застосунок командою `npm start`, після чого ви повинні побачити логи лише з модуля `OtherModule`. Якщо видалити фільтр з `OtherModule`, ви побачите багато деталізованої інформації з усіх модулів.
