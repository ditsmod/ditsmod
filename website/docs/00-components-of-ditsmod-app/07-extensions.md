...
Будь-яке розширення повинно входити в одну або декілька груп. Концепція **груп розширень** аналогічна до концепції групи [інтерсепторів][10], але група інтерсепторів працює над певним роутом, тоді як групи розширень готують метадані для обробників HTTP-запитів. Як правило, розширення в певній групі повертають метадані, що мають однаковий базовий інтерфейс.
