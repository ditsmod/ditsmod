...
Для того, щоб кожен із видів робіт можна було розрізняти, доповнювати розширеннями, і впорядковувати послідовність виконання, у Ditsmod існує концепція **груп розширень**. Кожне розширення повинно входити в одну або декілька груп.
