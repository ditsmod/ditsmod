...
### Створення токена нової групи {#creating-a-new-group-token}
...
### Реєстрація розширення у групі {#registering-an-extension-in-a-group}
