...
1. над одними й тими самими метаданими міг працювати цілий набір розширень, причому порядок роботи в межах даного набору є неважливим;
2. була можливість налаштовувати порядок роботи між різними наборами розширень.

Іншими словами, для формування однієї групи розширень, порядок роботи кожного з цих розширень є неважливим (як правило). З іншого боку, якщо порядок роботи між різними розширеннями є важливим, варто подумати про рознесення цих розширень у різні групи.

Будь-яке розширення повинно входити в одну або декілька груп. Під капотом Ditsmod, групи розширень - це по-суті групи [мульти-провайдерів][7], які, як правило, працюють над одними й тими самими метаданими, а також повертають інші метадані, що мають однаковий базовий інтерфейс.
