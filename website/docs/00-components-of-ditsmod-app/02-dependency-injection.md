...
Тобто, TypeScript-типи зникають з параметрів конструктора у JavaScript-коді. Отже, TypeScript під час компіляції повинен згенерувати спеціальну функцію, яка дозволить зберегти TypeScript-типи, які ми передаємо у параметри конструктора. Ця функція може бути, наприклад, такою:
