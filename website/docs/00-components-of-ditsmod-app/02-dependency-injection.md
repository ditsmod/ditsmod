...
Якщо ж контролер є [одинаком][103], його власний інжектор знаходиться на рівні роуту, і він має ще два батьківські інжектори на рівні модуля та застосунку:

- `providersPerApp`;
- `providersPerMod`;
- `providersPerRou` (<-- це масив, з якого формується інжектор для контролера одинака).
