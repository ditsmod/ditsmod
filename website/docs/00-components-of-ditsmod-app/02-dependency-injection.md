...
Вище сказано, що в конструкторах класів указуються залежності для того, щоб DI вирішував ці залежності. Зараз треба уточнити, що залежності в конструкторах указуються за допомогою так званих **токенів** - ідентифікаторів, з яких DI формує реєстр залежностей.
