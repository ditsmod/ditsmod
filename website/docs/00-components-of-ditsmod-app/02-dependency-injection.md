...
Токен залежності - це ідентифікатор, з яким асоціюється певна залежність. Таку асоціацію можна зробити у короткій та довгій формі вказання залежності. Давайте знову розглянемо попередній приклад:
