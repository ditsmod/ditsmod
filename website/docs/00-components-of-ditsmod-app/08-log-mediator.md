...
Результат можна побачити, якщо запустити застосунок командою `yarn start`, після чого вам повинно видатись саме те повідомлення, яке сформовано у даному методі.
...
Потім запустіть застосунок командою `yarn start`, після чого ви повинні побачити логи лише з модуля `OtherModule`. Якщо видалити фільтр з `OtherModule`, ви побачите багато деталізованої інформації з усіх модулів.
