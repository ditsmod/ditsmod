...
З модуля-хоста експортувати можна лише класи, або токени тих провайдерів, які [оголошені у формі об'єкта][4]. Тобто не можна експортувати безпосередньо провайдери у формі об'єкта:
...
Окрім цього, експортувати провайдери можна лише ті, що передаються в наступні масиви:
