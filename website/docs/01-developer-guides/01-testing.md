...
На даний момент, мабуть самим популярним фреймворком для написання юніт-тестів для JavaScript-коду є [jest][100]. В даній документації ми будемо використовувати саме цей фреймворк.
