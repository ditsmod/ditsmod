...
2. В даному режимі контролера, у методі класу можна оголосити довільну кількість параметрів. У даному разі ми оголосили три залежності: `service1` з типом даних `Service1`, `service2` з типом даних `Service2`, та `res` з типом даних `Res`. До речі, `res` - це скорочення від слова _response_.
