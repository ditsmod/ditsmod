...
`ExtensionsManager` використовується для запуску груп розширень, він також корисний тим, що кидає
помилки про циклічні залежності між розширеннями, і показує весь ланцюжок розширень, що призвів до
зациклення.
