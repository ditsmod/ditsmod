...
2. Decorators of the [root module, feature modules][5], and [mixin decorators][3] allow attaching certain metadata to module classes. During application scanning, this metadata is normalized and validated.
