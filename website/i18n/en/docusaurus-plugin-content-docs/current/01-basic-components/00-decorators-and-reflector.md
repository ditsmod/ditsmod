...
In Holu, decorators and the reflector are fundamental components that are used constantly and allow the application to be described declaratively. That's why learning Holu should start with this topic.

Let's try experimenting with preserving static class types. Create a file `src/app/services.ts` in the [holu/rest-starter][101] repository, and paste the following code into it:
...
[13]: https://github.com/holu/holu/blob/3.0.0-next.15/packages/core/package.json#L65
